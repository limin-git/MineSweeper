...
{	// 用组合法搜索子雷区
	...
	// 交集必然都是子雷区
	set_intersection(Set_Less_Than.begin(), Set_Less_Than.end(), Set_More_Than.begin(), Set_More_Than.end(), back_inserter(buff));
	vector< S_M_F >::iterator _i_v = buff.begin();
	for (; _i_v != buff.end(); ++_i_v) {
